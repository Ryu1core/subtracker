...
export default function StatusCards({ subscriptions, total }) {
    ...
    return (
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="bg-cozy-card dark:bg-cozy-dark-card cozy-shadow p-6 rounded-cozy border border-cozy-border dark:border-cozy-dark-border flex flex-col justify-between">
